...
import { ArrowLeft, PenTool, Lightbulb } from 'lucide-react'
...
export default function PodcastScripts() {
  ...
  const handleTechniqueClick = (techniqueId: string) => {
    navigate(`/podcast-scripts/${techniqueId}`)
  }
  ...
  return (
    <div className="py-12">
      ...
      <div className="text-center mb-12">
        <div className="text-sm text-gray-600 mb-4">🎙️ Podcast & Scripts</div>
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
          Choose a Prompt Technique for Podcast & Scripts
        </h1>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Select the right technique to craft engaging audio/video scripts.
        </p>
      </div>
